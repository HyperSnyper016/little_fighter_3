...
from game.constants import HENRY_FLUTE_SEQUENCE_DURATION
...
CHARACTERS = {
    ...
    "henry": {
        ...
        "animations": {
            ...
            "sp_vert_attack_2": {
                ...
                "frame_duration": HENRY_FLUTE_SEQUENCE_DURATION / 4,
                "loop": False,
            },
            "sprint_punch": {
    ...
    "freeze": {
        ...
        "animations": {
            "idle": {"files": _animation_files("freeze", "idle"), "frame_duration": 0.12, "loop": True},
            "walk": {"files": _animation_files("freeze", "movement", "walking"), "frame_duration": 0.09, "loop": True},
            "run": {"files": _animation_files("freeze", "movement", "sprinting"), "frame_duration": 0.07, "loop": True},
            "lift_heavy": {"files": _animation_files("freeze", "hold_item", "heavy_carry", "walk"), "frame_duration": 0.08, "loop": False},
            "fall": {"files": _animation_files("freeze", "fall", "knocked_down", "basic"), "frame_duration": 0.08, "loop": False},
            "knocked_fire": {"files": _animation_files("freeze", "fall", "knocked_down", "fire"), "frame_duration": 0.07, "loop": False},
            "knocked_freeze": {"files": _animation_files("freeze", "fall", "knocked_down", "ice", "freeze"), "frame_duration": 0.16, "loop": False},
            "knocked_freeze_break": {"files": _animation_files("freeze", "fall", "knocked_down", "ice", "freeze_break"), "frame_duration": 0.16, "loop": False},
            "get_up": {"files": _animation_files("freeze", "fall", "get_up"), "frame_duration": 0.12, "loop": False},
            ...
            "block_dodge": {"files": _prefixed_animation_files("1_", "freeze", "actions", "defend_actions", "dodge"), "frame_duration": 0.06, "loop": False},
            "block_dodge_alt": {"files": _prefixed_animation_files("1_", "freeze", "actions", "defend_actions", "dodge"), "frame_duration": 0.06, "loop": False},
            "attack_punch": {"files": _prefixed_animation_files("1_", "freeze", "actions", "basic_attack"), "frame_duration": 0.07, "loop": False},
            "attack_kick": {
                "files": [
                    *_prefixed_animation_files("2_", "freeze", "actions", "basic_attack"),
                    *_prefixed_animation_files("3_", "freeze", "actions", "basic_attack"),
                ],
                "frame_duration": 0.07,
                "loop": False,
            },
            "heavy_attack": {"files": _animation_files("freeze", "actions", "sp_move_attack_1"), "frame_duration": 0.08, "loop": False},
            "sp_move_attack_1": {"files": _animation_files("freeze", "actions", "sp_move_attack_1"), "frame_duration": 0.08, "loop": False},
            "sp_move_attack_2": {"files": _animation_files("freeze", "actions", "sp_move_attack_2"), "frame_duration": 0.08, "loop": False},
            ...
            "grapple_hit": {"files": _animation_files("freeze", "actions", "grapple_actions", "grappled", "hit_grappled"), "frame_duration": 0.10, "loop": False},
            "die": {"files": _animation_files("freeze", "hurt", "died"), "frame_duration": 0.12, "loop": False},
        },
        "movement": {
            "walk_speed": 220.0,
            "run_speed": 380.0,
    ...
    "jack": {
        ...
        "animations": {
            "idle": {"files": _animation_files("jack", "idle"), "frame_duration": 0.12, "loop": True},
            "walk": {"files": _animation_files("jack", "movement", "walking"), "frame_duration": 0.09, "loop": True},
            "run": {"files": _animation_files("jack", "movement", "sprinting"), "frame_duration": 0.07, "loop": True},
            "lift_heavy": {"files": _animation_files("jack", "hold_item", "heavy_carry", "walk"), "frame_duration": 0.08, "loop": False},
            "fall": {"files": _animation_files("jack", "fall", "knocked_down", "basic"), "frame_duration": 0.08, "loop": False},
            "knocked_fire": {"files": _animation_files("jack", "fall", "knocked_down", "fire"), "frame_duration": 0.07, "loop": False},
            "knocked_freeze": {"files": _animation_files("jack", "fall", "knocked_down", "ice", "freeze"), "frame_duration": 0.16, "loop": False},
            "knocked_freeze_break": {"files": _animation_files("jack", "fall", "knocked_down", "ice", "freeze_break"), "frame_duration": 0.16, "loop": False},
            "get_up": {"files": _animation_files("jack", "fall", "get_up"), "frame_duration": 0.12, "loop": False},
            "jump_normal": {"files": _animation_files("jack", "movement", "jump_actions", "basic_jump"), "frame_duration": 0.12, "loop": False},
            "jump_second": {"files": _animation_files("jack", "movement", "jump_actions", "second_jump"), "frame_duration": 0.12, "loop": False},
            "jump_attack": {"files": _animation_files("jack", "actions", "jump_attack"), "frame_duration": 0.08, "loop": False},
            "drink": {"files": _animation_files("jack", "hold_item", "drink"), "frame_duration": 0.08, "loop": True},
            "hurt": {"files": _animation_files("jack", "hurt", "basic_hurt"), "frame_duration": 0.08, "loop": False},
            "block": {"files": _animation_files("jack", "actions", "defend_actions", "defend"), "frame_duration": 0.10, "loop": False},
            "block_break": {"files": _animation_files("jack", "actions", "defend_actions", "defend_break"), "frame_duration": 0.10, "loop": False},
            "block_dodge": {"files": _animation_files("jack", "actions", "defend_actions", "dodge"), "frame_duration": 0.06, "loop": False},
            "attack_1": {"files": _prefixed_animation_files("1_", "jack", "actions", "basic_attack"), "frame_duration": 0.07, "loop": False},
            "attack_2": {"files": _prefixed_animation_files("2_", "jack", "actions", "basic_attack"), "frame_duration": 0.07, "loop": False},
            "sp_move_attack_1": {"files": _animation_files("jack", "actions", "sp_move_attack_1"), "frame_duration": 0.08, "loop": False},
            "sp_move_attack_2": {"files": _animation_files("jack", "actions", "sp_move_attack_2"), "frame_duration": 0.08, "loop": False},
            "sp_vert_attack_1": {"files": _animation_files("jack", "actions", "sp_vert_attack_1"), "frame_duration": 0.08, "loop": False},
            "sprint_punch": {"files": _animation_files("jack", "movement", "sprint_basic_attack"), "frame_duration": 0.07, "loop": False},
            "spawn": {"files": _animation_files("jack", "hold_item", "throw_item", "ground_throw"), "frame_duration": 0.08, "loop": False},
            "throw_heavy": {"files": _animation_files("jack", "hold_item", "heavy_carry", "throw"), "frame_duration": 0.08, "loop": False},
            "grapple": {"files": _animation_files("jack", "actions", "grapple_actions", "grappling"), "frame_duration": 0.10, "loop": False},
            "grappled": {"files": _animation_files("jack", "actions", "grapple_actions", "grappled"), "frame_duration": 0.12, "loop": False},
            "grapple_hit": {"files": _animation_files("jack", "actions", "grapple_actions", "grappled", "hit_grappled"), "frame_duration": 0.10, "loop": False},
            "die": {"files": _animation_files("jack", "hurt", "died"), "frame_duration": 0.12, "loop": False},
        },
        "movement": {
            "walk_speed": 220.0,
            "run_speed": 380.0,
    ...
    "jan": {
        ...
        "animations": {
            "idle": {"files": _animation_files("jan", "idle"), "frame_duration": 0.12, "loop": True},
            "walk": {"files": _animation_files("jan", "movement", "walking"), "frame_duration": 0.09, "loop": True},
            "run": {"files": _animation_files("jan", "movement", "sprinting"), "frame_duration": 0.07, "loop": True},
            "lift_heavy": {"files": _animation_files("jan", "hold_item", "heavy_carry", "walk"), "frame_duration": 0.08, "loop": False},
            "fall": {"files": _animation_files("jan", "fall", "knocked_down", "basic"), "frame_duration": 0.08, "loop": False},
            "knocked_fire": {"files": _animation_files("jan", "fall", "knocked_down", "fire"), "frame_duration": 0.07, "loop": False},
            "knocked_freeze": {"files": _animation_files("jan", "fall", "knocked_down", "ice", "freeze"), "frame_duration": 0.16, "loop": False},
            "knocked_freeze_break": {"files": _animation_files("jan", "fall", "knocked_down", "ice", "freeze_break"), "frame_duration": 0.16, "loop": False},
            "get_up": {"files": _animation_files("jan", "fall", "get_up"), "frame_duration": 0.12, "loop": False},
            "jump_normal": {"files": _animation_files("jan", "movement", "jump_actions", "basic_jump"), "frame_duration": 0.12, "loop": False},
            "jump_second": {"files": _animation_files("jan", "movement", "jump_actions", "second_jump"), "frame_duration": 0.12, "loop": False},
            "drink": {"files": _animation_files("jan", "hold_item", "drink"), "frame_duration": 0.08, "loop": True},
            "hurt": {"files": _animation_files("jan", "hurt", "basic_hurt"), "frame_duration": 0.08, "loop": False},
            "block": {"files": _animation_files("jan", "actions", "defend_actions", "defend"), "frame_duration": 0.10, "loop": False},
            "block_break": {"files": _animation_files("jan", "actions", "defend_actions", "defend_break"), "frame_duration": 0.10, "loop": False},
            "block_dodge": {"files": _animation_files("jan", "actions", "defend_actions", "dodge"), "frame_duration": 0.06, "loop": False},
            "attack_1": {"files": _prefixed_animation_files("1_", "jan", "actions", "basic_attack"), "frame_duration": 0.07, "loop": False},
            "attack_2": {"files": _prefixed_animation_files("2_", "jan", "actions", "basic_attack"), "frame_duration": 0.07, "loop": False},
            "attack_3": {"files": _prefixed_animation_files("3_", "jan", "actions", "basic_attack"), "frame_duration": 0.07, "loop": False},
            "sp_vert_attack_1": {"files": _animation_files("jan", "actions", "sp_vert_attack_1"), "frame_duration": 0.08, "loop": False},
            "sp_vert_attack_2": {"files": _animation_files("jan", "actions", "sp_vert_attack_2"), "frame_duration": 0.08, "loop": False},
            "sprint_punch": {"files": _animation_files("jan", "movement", "sprint_basic_attack"), "frame_duration": 0.07, "loop": False},
            "spawn": {"files": _animation_files("jan", "hold_item", "throw_item", "ground_throw"), "frame_duration": 0.08, "loop": False},
            "throw_heavy": {"files": _animation_files("jan", "hold_item", "heavy_carry", "throw"), "frame_duration": 0.08, "loop": False},
            "grapple": {"files": _animation_files("jan", "actions", "grapple_actions", "grappling"), "frame_duration": 0.10, "loop": False},
            "grappled": {"files": _animation_files("jan", "actions", "grapple_actions", "grappled"), "frame_duration": 0.12, "loop": False},
            "grapple_hit": {"files": _animation_files("jan", "actions", "grapple_actions", "grappled", "hit_grappled"), "frame_duration": 0.10, "loop": False},
            "die": {"files": _animation_files("jan", "hurt", "died"), "frame_duration": 0.12, "loop": False},
        },
        "movement": {
            "walk_speed": 220.0,
            "run_speed": 380.0,
